...
public class MessagingSessionUtils {
    ...
    /**
     * Get serviceIds from capabilities if available.
     * Otherwise return a default serviceId.
     * @param context
     * @return String[]
     */
    public static String[] getServicesIds(Context context){
        ...
        try{
            ...
            if (connectionManager!=null && connectionManager.isServiceConnected(RcsServiceName.CAPABILITY)) {
                Set<String> extensions = connectionManager.getCapabilityApi().getMyCapabilities().getSupportedExtensions();
