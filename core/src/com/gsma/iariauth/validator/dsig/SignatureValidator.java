...
public class SignatureValidator {
     ...
     */
    public SignatureValidator(TrustStore trustStore, Document doc, Element signatureNode,
            Set<String> expectedRefs, AuthType authType, String range) {
    ...
    private int validateSignatureProperties() {
         ...
         */
        String expectedRole = (authType == AuthType.RANGE) ? SignatureConstants.SIG_PROPERTY_ROLE_RANGE
