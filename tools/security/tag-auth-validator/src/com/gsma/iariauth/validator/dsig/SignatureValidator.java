...
public class SignatureValidator {
	 ...
	 */
	public SignatureValidator(TrustStore trustStore, Document doc, Element signatureNode, Set<String> expectedRefs, AuthType authType, String range) {
		this.certMgr = new PKIXCertificateManager(trustStore);
		this.doc = doc;
	...
	private int validateXMLSignature() {
		...
		try {
			validationContext = certMgr.getValidationContext(authType, range);
	...
	private int validateSignatureProperties() {
		 ...
		 */
		String expectedRole = (authType == AuthType.RANGE) ?
				SignatureConstants.SIG_PROPERTY_ROLE_RANGE :
				SignatureConstants.SIG_PROPERTY_ROLE_STANDALONE;
